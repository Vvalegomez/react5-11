...
export default function sOlmos() {
    return (
        <body id="page-top">
            <div id="wrapper">
                <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <li className="nav-item">
                        <a className="nav-item" href="index.html"></a>
                    ...
                    <li className="nav-item active">
                        ...
                        <div id="collapseTwo" className="collapse show" aria-aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div className="bg-white py-2 collapse-inner rounded">
                                <a className="collapse-item active" href="buttons.html">Sucursal Olmos</a>
                    ...
                    <li className="nav-item">
                        <a className="nav-item" href="charts.html">
                        ...
                        <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                            ...
                            <ul className="navbar-nav m1-auto">
                                <li className="nav-item dropdown no-arrow d-sm-none">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                                        <form className="form-inline mr-auto w-100 navbar-search">
                                            <div className="input-group">
                                                <input type="text" className="form-control bg-light border-0 small" placeholder="Buscar.." aria-label="Search" aria-labelledby="basic-addon2">
                                                    <div className="input-group-append">
                                                        <button className="btn btn-primary" type="button">
                                                            <i className="fas fa-search fa-sm"></i>
                                                        </button>
                                ...
                                <li className="nav-item dropdown no-arrow">
                                    <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-aria-expanded="false">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                        ...
                                        <a className="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModa">
